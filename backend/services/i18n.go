...
// NormalizeLang은 항상 "ko"를 반환한다 (한국어 고정).
func NormalizeLang(_ string) string {
	return defaultLang
}

// gradeLabel은 점수를 한국어 등급 문자열로 변환한다.
